...
let virtual-env = "/media/rabid/Development/PYTHON/python-playground/selenium"
let bin = "bin"
let path-sep = ":"
...
alias deactivate = source "/media/rabid/Development/PYTHON/python-playground/selenium/bin/deactivate.nu"
